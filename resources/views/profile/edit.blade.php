...
@extends(Auth::user()->role === 'admin' ? 'layouts.admin.app' : 'layouts.student.app')
            ...
            <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-4 text-center mb-4 mb-md-0">
                        ...
                        <div class="mt-2">
                            {{-- LOGIKA: Jika ada avatar di DB, tampilkan. Jika tidak, pakai UI Avatars (Inisial Nama) --}}
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('admin.dashboard') }}" class="btn btn-secondary px-4 fw-bold">Kembali</a>
                        </div>
