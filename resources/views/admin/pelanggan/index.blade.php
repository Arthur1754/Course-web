...
>
  <head>
    ...
    <title>Data Pelanggan | Sneat - Bootstrap 5 HTML Admin Template</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">
                <span class="text-muted fw-light">Pelanggan /</span> Data Pelanggan
              </h4>
              ...
              <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                  <h5 class="mb-0">List Data Pelanggan</h5>
                ...
                <div class="table-responsive text-nowrap">
                  <table class="table table-hover">
                    ...
                    <tbody class="table-border-bottom-0">
                      ...
                      <tr>
                        <td>{{ $index + 1 }}</td>
                        <td><strong>{{ $pelanggan->first_name }}</strong></td>
                        ...
                        <td>
                          ...
                          @elseif($pelanggan->gender == 'Female')
                            <span class="badge bg-label-info">Female</span>
                          @else
                            <span class="badge bg-label-secondary">{{ $pelanggan->gender }}</span>
                          @endif
                        </td>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="{{ route('pelanggan.edit', $pelanggan->pelanggan_id) }}">
                                <i class="bx bx-edit-alt me-1"></i> Edit
                              </a>
                              <form action="{{ route('pelanggan.destroy', $pelanggan->pelanggan_id) }}" method="POST" style="display: inline;">
                                @csrf
                                @method('DELETE')
